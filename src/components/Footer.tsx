...
import { MapPin, Phone, Mail, Facebook, Twitter, Linkedin, X, Instagram, MessageCircle } from 'lucide-react';
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2 md:col-span-1 col-span-2">
            ...
            <div className="flex items-center gap-5">
              <a href="https://www.facebook.com/logisticsjordan/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                <Facebook className="h-5 w-5" />
              </a>
              <a href="https://jo.linkedin.com/in/jordanian-logistics-association-7a3310264" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                <Linkedin className="h-5 w-5" />
              </a>
              <a href="https://www.facebook.com/messages/t/2145680512113549" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-gray-300">{t("contact_section.address_value")}</p>
